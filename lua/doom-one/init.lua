...
doom_one.set_colorscheme = function()
  ...
  set_hl("File", { fg = "fg" })
  set_hl("Directory", { fg = palette.blue, bold = true })
  ...
  set_hl("Include", { fg = palette.blue, bold = false })
  ...
  if config.ui.enable_treesitter then
    ...
    set_hl("@constructor", { fg = dark_theme and palette.yellow or palette.red, bold = true })
    ...
    set_hl("@function.call", { fg = dark_theme and palette.blue or palette.red, bold = true })
    set_hl("@include", { link = "Include" })
    set_hl("@keyword", { link = "Keyword" })
    set_hl("@keyword.function", { link = "KeywordFunction" })
    set_hl("@method.call", { fg = dark_theme and palette.blue or palette.red, bold = true })
    ...
    set_hl("@string.escape", { fg = dark_theme and palette.fg or palette.red })
